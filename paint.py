...
#If the apple one doesn't work we should try UA testing User-Agent: CaptiveNetworkSupport/1.0 wispr
...
#	return redirect("http://10.5.5.1/", code=511)	
#	return redirect("http://10.5.5.1/", code=302)	
#	return "oops"
